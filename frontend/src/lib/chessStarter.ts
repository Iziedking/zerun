// The starter agent, shown and downloadable on the build guide. It is a working entry: shortlist
// the captures deterministically, ask 0G to pick from the shortlist, fall back if the model is
