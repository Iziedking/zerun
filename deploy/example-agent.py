...
You get ONE call to call_model(prompt) per move — a real inference on 0G, provided by Zerun. Use
it to think; the deterministic code around it is your edge. It may raise, so always have a fallback.
